        ...
        <Layout>
            <div className="container-fluid" data-spy="scroll" data-target="#navbar-example2" data-offset="0">
                ...
                <div className="row mt-5">
                    ...
                    <div className="col-xs-12 offset-lg-4 col-lg-4 float-right">
                ...
                <section id="solution" className="fullScreenSection p-5">
                <h3 className="title text-left">La solución se convierte en un nuevo problema</h3>
                    ...
                    <div className="row mt-5 h-100">
                        ...
                        <div className="col-xs-12 offset-lg-3 col-lg-5">
                ...
                <section id="approach" className="fullScreenSection p-5">
                    <div className="row">
                        <div className="col-xs-12 col-lg-4">
                            <h3 className="text-left title">Nuestro Enfoque</h3>
                        </div>
                    </div>
                    <div className="row mt-5 card-deck">
                    <div className="col-lg-2"></div>
                    {data.approach.map((card) => {
                        return(
                            <div className="col-xs-12 col-lg-2 fullCard">
                                <Card data={card}></Card>
                            </div>
                        )
                    })}
